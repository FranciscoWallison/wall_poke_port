...
class Monster extends Sprite {
  ...
  attack({ attack, recipient, renderedSprites }) {
    ...
    switch (attack.name) {
      ...
      case 'ThornLeaves':
        audio.initFireball.play()
        const thornLeavesImage = new Image()
        thornLeavesImage.src = './img/battle/thornLeaves.png'
        const thornLeaves = new Sprite({
          position: {
            x: this.position.x,
            y: this.position.y
          },
          image: thornLeavesImage,
          frames: {
            max: 4,
            hold: 10
          },
        ...
        renderedSprites.splice(1, 0, thornLeaves)

        gsap.to(thornLeaves.position, {
          x: recipient.position.x,
          y: recipient.position.y,
          onComplete: () => {
            // Enemy actually gets hit
